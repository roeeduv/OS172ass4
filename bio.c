...
int free_block_number; // each time block state is B_BUSY decremen
int number_of_hits; // each time the block is in the cache
int number_of_block_acsses; // each time we call bget
